...
class DocumentsUploadBody(object):
    ...
    def __init__(self, file=None):  # noqa: E501
        """DocumentsUploadBody - a model defined in Swagger"""  # noqa: E501
        self._file = None
    ...
    @property
    def file(self):
        """Gets the file of this DocumentsUploadBody.  # noqa: E501

        PDF file to upload  # noqa: E501

        :return: The file of this DocumentsUploadBody.  # noqa: E501
        :rtype: str
        """
        return self._file
    ...
    @file.setter
    def file(self, file):
        """Sets the file of this DocumentsUploadBody.

        PDF file to upload  # noqa: E501

        :param file: The file of this DocumentsUploadBody.  # noqa: E501
        :type: str
        """
        if file is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DocumentsUploadBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DocumentsUploadBody):
            return False
